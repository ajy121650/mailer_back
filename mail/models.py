...
class EmailRecipient(models.Model):
    ...
    email = models.ForeignKey(Email, on_delete=models.CASCADE, related_name='recipients', verbose_name="이메일")
...
class Mailbox(models.Model):
    ...
    account = models.ForeignKey('user.EmailAccount', on_delete=models.CASCADE, related_name='mailbox_items', verbose_name="이메일 계정")
    email = models.ForeignKey(Email, on_delete=models.CASCADE, related_name='mailbox_entries', verbose_name="이메일")
...
class Attachment(models.Model):
    email = models.ForeignKey(Email, on_delete=models.CASCADE, related_name='attachments', verbose_name="이메일")
