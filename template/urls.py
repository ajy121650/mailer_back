...
urlpatterns = [
    path("viewtemplate/list/", ViewTemplateListView.as_view(), name="template-list"),
    ...
    path("mytemplate/list/<int:user_id>/", MyTemplateListView.as_view(), name="my-template-list"),
